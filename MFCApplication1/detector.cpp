                           ...
                           const cv::Size& inputSize = cv::Size(640, 640))
{
	...
	std::wstring w_modelPath = Cutils::charToWstring(modelPath.c_str());
...
void YOLODetector::preprocessing(cv::Mat &image, float*& blob, std::vector<int64_t>& inputTensorShape)
{
	...
	Cutils::letterbox(image, resizedImage, this->inputImageShape,
                                                    ...
                                                    const float& confThreshold, const float& iouThreshold)
{
    ...
    for (int idx : indices)
    {
		...
		Cutils::scaleCoords(resizedImageShape, det.box, originalImageShape);
                                            ...
                                            const float& iouThreshold = 0.45)
{
    ...
    size_t inputTensorSize = Cutils::vectorProduct(inputTensorShape);
